...
Operation = 'SEM-DML_SiO2_EtchingDepth'
TestStation = 'SEM-DML'
...
########## 取得するデータの列番号を定義 ##########
Row_Operator = 10
Row_EtchingDepth_1 = 49
Row_EtchingDepth_2 = 50
Row_EtchingDepth_3 = 51
Row_EtchingDepth_Ave = 52
...
key_type = {
    ...
    "key_Operator": str,
    "key_EtchingDepth_1": float,
    "key_EtchingDepth_2": float,
    "key_EtchingDepth_3": float,
    "key_EtchingDepth_Ave": float
}
...
def Open_Data_Sheet(filepath, start_date_time, part_number, serial_number, nine_serial_number):
    ...
    data_dict = {
        ...
        "key_EtchingDepth_1": sheet.cell(Row_EtchingDepth_1, 4).value,
        "key_EtchingDepth_2": sheet.cell(Row_EtchingDepth_2, 4).value,
        "key_EtchingDepth_3": sheet.cell(Row_EtchingDepth_3, 4).value,
        "key_EtchingDepth_Ave": sheet.cell(Row_EtchingDepth_Ave, 4).value
    }
...
def Output_XML(xml_file, data_dict):
    ...
    f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="EtchingDepth_1" Units="um" Value=' + '"' + str(data_dict["key_EtchingDepth_1"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="EtchingDepth_2" Units="um" Value=' + '"' + str(data_dict["key_EtchingDepth_2"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="EtchingDepth_3" Units="um" Value=' + '"' + str(data_dict["key_EtchingDepth_3"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="EtchingDepth_Ave" Units="um" Value=' + '"' + str(data_dict["key_EtchingDepth_Ave"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
