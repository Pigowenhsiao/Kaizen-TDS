...
def Open_Data_Sheet(filepath, start_date_time, part_number, serial_number, nine_serial_number):
    ...
    data_dict = {
        ...
        "key_Depth_1": sheet.cell(Row_Depth_1, 4).value,
        "key_Depth_2": sheet.cell(Row_Depth_2, 4).value,
        "key_Depth_3": sheet.cell(Row_Depth_3, 4).value,
        "key_Depth_Ave": sheet.cell(Row_Depth_Ave, 4).value
    }
...
def Output_XML(xml_file, data_dict):
    ...
    f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
            ...
            '\n'
            '               <TestStep Name="ISO" startDateTime=' + '"' + data_dict["key_Start_date_time"].replace(".", ":") + '"' + ' Status="Passed">' + '\n' +
            '                   <Data DataType="Numeric" Name="Depth_1" Units="um" Value=' + '"' + str(data_dict["key_Depth_1"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Depth_2" Units="um" Value=' + '"' + str(data_dict["key_Depth_2"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Depth_3" Units="um" Value=' + '"' + str(data_dict["key_Depth_3"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Depth_Ave" Units="um" Value=' + '"' + str(data_dict["key_Depth_Ave"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
