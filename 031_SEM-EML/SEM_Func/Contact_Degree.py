...
Operation = 'SEM-EML_Contact_Degree'
TestStation = 'SEM-EML'
...
def Open_Data_Sheet(filepath, start_date_time, part_number, serial_number, nine_serial_number):
    ...
    data_dict = {
        ...
        "key_Degree_1": sheet.cell(Row_Degree_1, 16).value,
        "key_Degree_2": sheet.cell(Row_Degree_2, 16).value,
        "key_Degree_3": sheet.cell(Row_Degree_3, 16).value,
        "key_Degree_Ave": sheet.cell(Row_Degree_Ave, 16).value
    }
...
def Output_XML(xml_file, data_dict):
    ...
    f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
            ...
            '\n'
            '               <TestStep Name="Contact" startDateTime=' + '"' + data_dict["key_Start_date_time"].replace(".", ":") + '"' + ' Status="Passed">' + '\n' +
            '                   <Data DataType="Numeric" Name="Degree_1" Units="degree" Value=' + '"' + str(data_dict["key_Degree_1"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Degree_2" Units="degree" Value=' + '"' + str(data_dict["key_Degree_2"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Degree_3" Units="degree" Value=' + '"' + str(data_dict["key_Degree_3"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Degree_Ave" Units="degree" Value=' + '"' + str(data_dict["key_Degree_Ave"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
