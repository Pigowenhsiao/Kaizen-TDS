...
Operation = 'SEM-EML_Ru_Thickness'
TestStation = 'SEM-EML'
...
def Open_Data_Sheet(filepath, start_date_time, part_number, serial_number, nine_serial_number):
    ...
    data_dict = {
        ...
        "key_Thickness_1": sheet.cell(Row_Thickness_1, 4).value,
        "key_Thickness_2": sheet.cell(Row_Thickness_2, 4).value,
        "key_Thickness_3": sheet.cell(Row_Thickness_3, 4).value,
        "key_Thickness_Ave": sheet.cell(Row_Thickness_Ave, 4).value
    }
...
def Output_XML(xml_file, data_dict):
    ...
    f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
            ...
            '\n'
            '               <TestStep Name="Ru" startDateTime=' + '"' + data_dict["key_Start_date_time"].replace(".", ":") + '"' + ' Status="Passed">' + '\n' +
            '                   <Data DataType="Numeric" Name="Thickness_1" Units="um" Value=' + '"' + str(data_dict["key_Thickness_1"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Thickness_2" Units="um" Value=' + '"' + str(data_dict["key_Thickness_2"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Thickness_3" Units="um" Value=' + '"' + str(data_dict["key_Thickness_3"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Thickness_Ave" Units="um" Value=' + '"' + str(data_dict["key_Thickness_Ave"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
