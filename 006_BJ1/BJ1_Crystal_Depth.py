...
Log_File = '../Log/' + Log_Folder_Name + '/006_BJ1.log'
...
def Main(FilePath, FileName, TextFile, Equipment):
    ...
    Excel_File = shutil.copy(Excel_file_list[0][0], '../DataFile/006_BJ1/')
    ...
    # Filter out rows where column E (index 4) is not equal to 0
    df = df[df.iloc[:, 4] != 0]
    ...
    shutil.copy(TextFile, 'T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/006_BJ1/13_ProgramUsedFile/')


if __name__ == '__main__':
    
    Main('Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ2号機/3インチ/HTL13★＊＊/', '*ドライ2号機_3インチ_HTL13★＊＊_BJ1ドライエッチプログラムシート*.xlsm', 'BJ1_HL13B6_StartRow_Dry2.txt', '#2') ##2025/01/09 New Add

    Main('Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ1号機/3インチ/HTL13★＊＊/', '*3ｲﾝﾁ_HTL13★＊＊_*BJ1ﾄﾞﾗｲｴｯﾁﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsm', 'BJ1_HTL13_StartRow_Dry1.txt', '#1')
    Main('Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ1号機/3インチ/HL13B6/', '*3ｲﾝﾁ_HL13B6-BT＊＊_*BJ1ﾄﾞﾗｲｴｯﾁﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsm', 'BJ1_HL13B6_StartRow_Dry1.txt', '#1')
    Main('Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ1号機/3インチ/HL15B5/', '*3ｲﾝﾁ_HL15B5-BT＊＊_*BJ1ﾄﾞﾗｲｴｯﾁﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsm', 'BJ1_HL15B5_StartRow_Dry1.txt', '#1')
    Main('Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ5号機/3インチ/HTL13★＊＊/', '*ドライ5号機_HTL13★＊＊_*BJ1ﾄﾞﾗｲｴｯﾁﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsx', 'BJ1_HTL13_StartRow_Dry5.txt', '#5')
    Main('Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ5号機/3インチ/HL13B6/', '*ドライ5号機_HL13B6-BT＊＊_*BJ1ﾄﾞﾗｲｴｯﾁﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsx', 'BJ1_HL13B6_StartRow_Dry5.txt', '#5')
    Main('Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ5号機/3インチ/HL15B5/', '*ドライ5号機_HL15B5-BT＊＊_*BJ1ﾄﾞﾗｲｴｯﾁﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsx', 'BJ1_HL15B5_StartRow_Dry5.txt', '#5')
