...
import numpy as np
import pandas as pd
from datetime import datetime, date, timedelta # *** New feature: Import timedelta ***
...
class IniSettings:
    def __init__(self):
        ...
        self.tool_name_map = {}
        self.field_map = {}
        self.retention_date = 0 # *** New feature: Add retention_date attribute ***
...
def _extract_settings_from_config(config):
    ...
    # *** New feature: Read retention_date setting ***
...
def process_single_excel_file(filepath, settings, log_file):
    ...
    # *** New feature: Date filtering logic ***
    try:
        # Get the date column index from the INI settings
        ...
        return # If date filtering fails, skip this file

    # Keep only rows where the key column (main etch time, index=7) has a value
