...
Log_File = '../Log/' + Log_Folder_Name + '/005_BJ1.log'
...
def Main(FilePath, FileName, TextFile, Equipment):
    ...
    Excel_File = shutil.copy(Excel_file_list[0][0], '../DataFile/005_BJ1/')
    ...
    df = pd.read_excel(Excel_File, header=None, sheet_name=Data_Sheet_Name, usecols="B:AK", skiprows=Start_Number)
    ...
    while Row_Number < row_end:
        ...
        print(PartNumber,Nine_Serial_Number,Serial_Number)
        input("enter")
        ...
        data_dict = {
            ...
            "key_Rate_3sig": df.iloc[Row_Number, Col_Rate_3sig],
        ...
        f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
                ...
                '               <HeaderMisc>' + '\n' +
                '                   <Item Description="Process">' + data_dict["key_Process"] + '</Item>' + '\n'
                '               </HeaderMisc>' + '\n' +
                '\n'
                ...
                '                   <Data DataType="Numeric" Name="Rate_3sigma" Units="nm/min" Value=' + '"' + str(data_dict["key_Rate_3sig"]) + '"/>' + '\n' +
                '               </TestStep>' + '\n' +
    ...
    #shutil.copy(TextFile, 'T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/005_BJ1/13_ProgramUsedFile/')


if __name__ == '__main__':
    
    Main("Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ3号機/3ｲﾝﾁ/", "*3ｲﾝﾁ*BJﾏｽｸ形成*SiO2膜ﾄﾞﾗｲｴｯﾁ ﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsm", "BJ1_Dry3_StartRow.txt", '3')
    Main("Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ6号機/3ｲﾝﾁ/", "*3ｲﾝﾁ*BJﾏｽｸ形成*SiO2膜ﾄﾞﾗｲｴｯﾁ(ドライ6号機)*ﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsm", "BJ1_Dry6_StartRow.txt", '6')
