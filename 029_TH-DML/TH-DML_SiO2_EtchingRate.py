...
Operation = 'TH-DML_SiO2_EtchingRate'
TestStation = 'TH-DML'
...
Log_File = '../Log/' + Log_Folder_Name + '/029_TH-DML.log'
...
# Output_filepath = '../XML/029_TH-DML/'
...
def Main():
    ...
    Excel_File = shutil.copy(Excel_File_List[0][0], '../DataFile/029_TH-DML/')
    ...
    df = pd.read_excel(Excel_File, header=None, sheet_name=Data_Sheet_Name, usecols="E:I", skiprows=Start_Number)
    ...
    while Row_Number < row_end:
        ...
        data_dict = {
            ...
            'key_Equipment': str(df.iloc[Row_Number, Col_Equipment])[3:],
            'key_Rate_Rate_Ave': df.iloc[Row_Number, Col_Rate_Rate_Ave]
        }
        ...
        f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
                ...
                '                   <Data DataType="Numeric" Name="Rate_Ave" Units="nm/min" Value=' + '"' + str(data_dict["key_Rate_Rate_Ave"]) + '"/>' + '\n' +
                '               </TestStep>' + '\n' +
                '\n'
    ...
    shutil.copy("TH-DML_StartRow.txt", 'T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/029_TH-DML/13_ProgramUsedFile/')
