...
Log_File = '../Log/' + Log_Folder_Name + '/021_MESA.log'
...
Col_Serial_Number = 3
Col_Equipment = 4
Col_Depth_Depth_Initial = 5
Col_Depth_Depth_Final = 6
...
key_type = {
    ...
    'key_Part_Number': str,
    'key_Equipment': str,
    'key_Depth_Depth_Initial': float,
    'key_Depth_Depth_Final': float,
...
def Main():
    ...
    FileName = '*QC-K-003-R05*ｷｬｯﾌﾟ層ﾄﾞﾗｲｴｯﾁ*.xls*'
    Excel_File_List = []
    ...
    Excel_File = shutil.copy(Excel_File_List[0][0], '../DataFile/021_MESA/')
    ...
    df = pd.read_excel(Excel_File, header=None, sheet_name=Data_Sheet_Name, usecols="B:I", skiprows=Start_Number)
    ...
    while Row_Number < row_end:
        ...
        data_dict = {
            ...
            'key_Depth_Depth_Initial': df.iloc[Row_Number, Col_Depth_Depth_Initial],
            'key_Depth_Depth_Final': df.iloc[Row_Number, Col_Depth_Depth_Final]
        }
        ...
        f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
                ...
                '                   <Data DataType="Numeric" Name="Depth_Initial" Units="nm" Value=' + '"' + str(data_dict["key_Depth_Depth_Initial"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="Depth_Final" Units="nm" Value=' + '"' + str(data_dict["key_Depth_Depth_Final"]) + '"/>' + '\n' +
                '               </TestStep>' + '\n' +
                '\n'
                ...
                '\n'
                '               <TestEquipment>' + '\n' +
                '                   <Item DeviceName="DryEtch" DeviceSerialNumber="#1"/>' + '\n' +
    ...
    shutil.copy("MESA_StartRow.txt", 'T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/021_MESA/13_ProgramUsedFile/')
