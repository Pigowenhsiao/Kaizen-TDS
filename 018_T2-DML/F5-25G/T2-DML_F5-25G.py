...
# ----- ログ書き込み先ファイルパス -----
Log_file = '../../Log/' + Log_FolderName + '/018_T2-DML_F5-25G.log'
...
# Output_filepath = '../../XML/018_T2-DML/F5-25G/'
...
teststep_dict = {
    ...
    'TestStep12' : 'Si2H6-10ppm',
    'TestStep13' : 'DMZn-B-0.1percent',
    'TestStep14' : 'AsH3-5percent',
    'TestStep15' : 'Temperature',
    'TestStep16' : 'Piezocon',
    'TestStep17' : 'BallastN2',
    'TestStep18' : 'CH3Cl-Judge',
    'TestStep19' : 'MO-Temperature',
    'TestStep20' : 'SORTED_DATA',
}
...
key_type = {
    ...
    "key_PH3-50percent_Step15" : float, 
    "key_PH3-50percent_Step21" : float, 
    "key_PH3-50percent_Step27" : float, 
    "key_PH3-50percent_Step41" : float, 
    "key_CH3Cl-5percent_Step7" : float, 
    "key_Si2H6-10ppm_Step41" : float, 
    ...
    "key_DMZn-B-0.1percent_Step15" : float, 
    "key_DMZn-B-0.1percent_Step21" : float, 
    "key_DMZn-B-0.1percent_Step27" : float, 
    "key_DMZn-B-0.1percent_Step33" : float, 
    "key_DMZn-B-0.1percent_Step34" : float, 
    "key_DMZn-B-0.1percent_Step35" : float, 
    "key_DMZn-B-0.1percent_Step36" : float, 
...
with open('T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/018_T2-DML/SerialNumber_Initial_25G.txt', 'r', encoding='utf-8') as textfile:
    SerialNumber_list = {s.strip() for s in textfile.readlines()}


########## 前回処理を行ったファイル名を取得する ##########
with open('F5_FileName_F5-25G.txt', 'r', encoding='utf-8') as textfile:
...
def Open_Data_Sheet(Sheet, filepath, SheetName):
    ...
    Step34 = str(Sheet['Z31'].value)
    if Step11 is not None and (Step11[-1]=='↑' or Step11[-1]=='↓'):
        Step11 = Step11[:-1]
    if Step34 is not None and (Step34[-1]=='↑' or Step34[-1]=='↓'):
        Step34 = Step34[:-1]
    ...
    data_dict = {
        ...
        "key_XRayDiffraction_Strain" : Sheet['M47'].value,
        "key_CarrierConcentration_Clad" : Sheet['M51'].value,
        "key_CarrierConcentration_Contact" : Sheet['M50'].value,
        "key_CarrierConcentration_Minimum" : Sheet['M52'].value,
        "key_Thickness_Contact" : Sheet['M55'].value,
        "key_Thickness_Clad" : Sheet['M56'].value,
        "key_Particles_Particles" : Sheet['M60'].value,
        ...
        "key_Dulation_Step15" : Sheet['I27'].value,
        "key_Dulation_Step21" : Sheet['I28'].value,
        ...
        "key_Dulation_Step36" : Sheet['I33'].value,
        "key_Dulation_Step41" : Sheet['I34'].value,
        "key_MO1-TEG_Step21" : Sheet['K28'].value,
        "key_MO1-TEG_Step27" : Sheet['K29'].value,
        "key_MO1-TEG_Step33" : Sheet['K30'].value,
        "key_MO1-TEG_Step34" : Sheet['K31'].value,
        "key_MO1-TEG_Step35" : Sheet['K32'].value,
        "key_MO1-TEG_Step36" : Sheet['K33'].value,
        ...
        "key_MO9-TMI_Step15" : Sheet['S27'].value,
        "key_MO9-TMI_Step21" : Sheet['S28'].value,
        "key_MO9-TMI_Step27" : Sheet['S29'].value,
        "key_MO9-TMI_Step33" : Sheet['S30'].value,
        "key_MO9-TMI_Step34" : Sheet['S31'].value,
        "key_MO9-TMI_Step35" : Sheet['S32'].value,
        "key_MO9-TMI_Step36" : Sheet['S33'].value,
        "key_MO9-TMI_Step41" : Sheet['S34'].value,
        "key_AsH3-A-20percent_Step27" : Sheet['T29'].value,
        ...
        "key_AsH3-A-20percent_Step36" : Sheet['T33'].value,
        ...
        "key_PH3-50percent_Step15" : Sheet['U27'].value,
        "key_PH3-50percent_Step21" : Sheet['U28'].value,
        "key_PH3-50percent_Step27" : Sheet['U29'].value,
        "key_PH3-50percent_Step41" : Sheet['U34'].value,
        "key_CH3Cl-5percent_Step7" : Sheet['V21'].value,
        "key_Si2H6-10ppm_Step41" : Sheet['W34'].value,
        ...
        "key_DMZn-B-0.1percent_Step15" : Sheet['X27'].value,
        "key_DMZn-B-0.1percent_Step21" : Sheet['X28'].value,
        "key_DMZn-B-0.1percent_Step27" : Sheet['X29'].value,
        ...
        "key_DMZn-B-0.1percent_Step36" : Sheet['X33'].value,
        "key_AsH3-5percent_Step21" : Sheet['Y28'].value,
        ...
        "key_Temperature_Step15" : Sheet['Z27'].value,
        "key_Temperature_Step21" : Sheet['Z28'].value,
        "key_Temperature_Step27" : Sheet['Z29'].value,
        "key_Temperature_Step33" : Sheet['Z30'].value,
        "key_Temperature_Step34" : Step34,
        "key_Temperature_Step35" : Sheet['Z32'].value,
        "key_Temperature_Step36" : Sheet['Z33'].value,
        "key_Temperature_Step41" : Sheet['Z34'].value,
        "key_Piezocon_F1" : Sheet['AE40'].value,
        "key_Piezocon_F1_Inverse" : Sheet['AE41'].value,
        "key_Piezocon_F5_Start" : Sheet['AE46'].value,
        "key_Piezocon_F5_Current" : Sheet['AE47'].value,
        "key_BallastN2_BallastN2" : Sheet['AE43'].value,
        "key_CH3Cl-Judge_StartTime" : Sheet['AE51'].value,
        "key_CH3Cl-Judge_StablWaitTime" : Sheet['AE53'].value,
        "key_CH3Cl-Judge_EtchingTime" : Sheet['AE55'].value,
        "key_CH3Cl-Judge_EtchingStartTemperature" : Sheet['AE57'].value,
        "key_MO-Temperature_MO1-TEG(A)" : Sheet['K43'].value,
        "key_MO-Temperature_MO2-TMA(A)" : Sheet['L43'].value,
        "key_MO-Temperature_MO3-DEZ" : Sheet['M43'].value,
        "key_MO-Temperature_MO4-TMI(A)" : Sheet['N43'].value,
        "key_MO-Temperature_MO5-TMI(B)" : Sheet['O43'].value,
        "key_MO-Temperature_MO6-TEG(B)" : Sheet['P43'].value,
        "key_MO-Temperature_MO7-TMA(B)" : Sheet['Q43'].value,
        "key_MO-Temperature_MO8-CBr4" : Sheet['R43'].value,
        "key_MO-Temperature_MO9-TMI" : Sheet['S43'].value,
        "key_Polaron": Polaron,
        "key_SEM": SEM,
        "key_XRD": XRD,
        "key_MOCVD": MOCVD,
...
def Output_XML(xml_file, data_dict):
    ...
    f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step36" Units="min" Value=' + '"' + str(data_dict["key_Dulation_Step36"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step41" Units="min" Value=' + '"' + str(data_dict["key_Dulation_Step41"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            '               <TestStep Name=' + '"' + teststep_dict["TestStep7"] + '"' + ' startDateTime=' + '"' + data_dict["key_start_date_time"] + '"' + ' Status="Passed">' + '\n' +
            '                   <Data DataType="Numeric" Name="Step21" Units="sccm" Value=' + '"' + str(data_dict["key_MO1-TEG_Step21"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step27" Units="sccm" Value=' + '"' + str(data_dict["key_MO1-TEG_Step27"]) + '"/>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step36" Units="sccm" Value=' + '"' + str(data_dict["key_MO1-TEG_Step36"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step15" Units="sccm" Value=' + '"' + str(data_dict["key_MO9-TMI_Step15"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step21" Units="sccm" Value=' + '"' + str(data_dict["key_MO9-TMI_Step21"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step27" Units="sccm" Value=' + '"' + str(data_dict["key_MO9-TMI_Step27"]) + '"/>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step36" Units="sccm" Value=' + '"' + str(data_dict["key_MO9-TMI_Step36"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step41" Units="sccm" Value=' + '"' + str(data_dict["key_MO9-TMI_Step41"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            '               <TestStep Name=' + '"' + teststep_dict["TestStep9"] + '"' + ' startDateTime=' + '"' + data_dict["key_start_date_time"] + '"' + ' Status="Passed">' + '\n' +
            '                   <Data DataType="Numeric" Name="Step27" Units="sccm" Value=' + '"' + str(data_dict["key_AsH3-A-20percent_Step27"]) + '"/>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step36" Units="sccm" Value=' + '"' + str(data_dict["key_AsH3-A-20percent_Step36"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step15" Units="sccm" Value=' + '"' + str(data_dict["key_PH3-50percent_Step15"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step21" Units="sccm" Value=' + '"' + str(data_dict["key_PH3-50percent_Step21"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step27" Units="sccm" Value=' + '"' + str(data_dict["key_PH3-50percent_Step27"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step41" Units="sccm" Value=' + '"' + str(data_dict["key_PH3-50percent_Step41"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step41" Units="sccm" Value=' + '"' + str(data_dict["key_Si2H6-10ppm_Step41"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step15" Units="sccm" Value=' + '"' + str(data_dict["key_DMZn-B-0.1percent_Step15"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step21" Units="sccm" Value=' + '"' + str(data_dict["key_DMZn-B-0.1percent_Step21"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step27" Units="sccm" Value=' + '"' + str(data_dict["key_DMZn-B-0.1percent_Step27"]) + '"/>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step36" Units="sccm" Value=' + '"' + str(data_dict["key_DMZn-B-0.1percent_Step36"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step41" Units="degree" Value=' + '"' + str(data_dict["key_Temperature_Step41"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
...
def Data_Extract(filepath, SheetList, old_check):
    ...
    for Sheet_Name in SheetList[::-1]:
        ...
        # ----- シートが処理対象シートかどうか確認 -----
        if '13BFCP50-T2.exe' not in str(Sheet['U3'].value) or Initial not in SerialNumber_list:
...
if __name__ == '__main__':
    ...
    # ----- ログ記載：着工ファイル検索 -----
    Log.Log_Info(Log_file, 'FB File Search')
    ...
    # ----- エピ番号の書き込み -----
    with open('F5_FileName_F5-25G.txt', 'w', encoding='utf-8') as textfile:
        textfile.write(FileName)

    # ----- 最終行を書き込んだファイルをGドライブに転送 -----
    shutil.copy("F5_FileName_F5-25G.txt", 'T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/018_T2-DML/F5-25G/13_ProgramUsedFile/')
