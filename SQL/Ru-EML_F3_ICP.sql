SELECT 
    ...
    Int_Data."Particles",
    Int_Data."BallastN2",
    Int_Data."MO-Temperature_MO7-TMI",
    Int_Data."MO-Temperature_MO8-Fe",
    Int_Data."MO-Temperature_MO6-Ru",
    Int_Data."Dulation_Step7",
    Int_Data."Dulation_Step8",
    Int_Data."Dulation_Step9",
    Int_Data."Dulation_Step10",
    Int_Data."Dulation_Step11",
    Int_Data."MO7-TMI_Step10",
    Int_Data."MO7-TMI_Step11",
    Int_Data."MO6-Ru_Step10",
    Int_Data."MO6-Ru_Step11",
    Int_Data."PH3-A-50percent_Step7",
    Int_Data."PH3-A-50percent_Step8",
    Int_Data."PH3-A-50percent_Step9",
    Int_Data."PH3-A-50percent_Step10",
    Int_Data."PH3-A-50percent_Step11",
    Int_Data."CH3Cl-5percent_Step7",
    Int_Data."CH3Cl-5percent_Step10",
    Int_Data."CH3Cl-5percent_Step11",
    ...
    Int_Data."TMInPiezoconConc_ZeroValue",
    Int_Data."TMInPiezoconConc_Check",
    Int_Data."TMInPiezoconConc_EPI",
    Int_Data."TMInPiezoconConc_CheckFlow",
    Int_Data."TMInPiezoconConcOffset_Check",
    Int_Data."TMInPiezoconConcOffset_EPI",
    Int_Data."TMInPiezoconConcOffset_CheckFlow",
...
FROM(
    ...
    WHERE 1=1
        ...
        AND HDR.OPERATION               = 'Ru-EML_F3ICP'
    GROUP BY
        HDR.TESTHEADERID,
        STARTTIME,
        PARTNUMBER,
...
PIVOT(
    MAX(VALUE) FOR TESTSTEPS IN(
        ...
        'MO-Temperature_MO7-TMI' AS "MO-Temperature_MO7-TMI",
        'MO-Temperature_MO8-Fe' AS "MO-Temperature_MO8-Fe",
        'MO-Temperature_MO6-Ru' AS "MO-Temperature_MO6-Ru",
        ...
        'MO7-TMI_Step10' AS "MO7-TMI_Step10",
        'MO7-TMI_Step11' AS "MO7-TMI_Step11",
        'MO6-Ru_Step10' AS "MO6-Ru_Step10",
        'MO6-Ru_Step11' AS "MO6-Ru_Step11",
        ...
        'CH3Cl-5percent_Step10' AS "CH3Cl-5percent_Step10",
        'CH3Cl-5percent_Step11' AS "CH3Cl-5percent_Step11",
        ...
        'TMInPiezoconConc_TMInPiezoconConc_ZeroValue' AS "TMInPiezoconConc_ZeroValue",
        ...
        'TMInPiezoconConcOffset_TMInPiezoconConcOffset_Check' AS "TMInPiezoconConcOffset_Check",
        'TMInPiezoconConcOffset_TMInPiezoconConcOffset_EPI' AS "TMInPiezoconConcOffset_EPI",
        'TMInPiezoconConcOffset_TMInPiezoconConcOffset_CheckFlow' AS "TMInPiezoconConcOffset_CheckFlow",
