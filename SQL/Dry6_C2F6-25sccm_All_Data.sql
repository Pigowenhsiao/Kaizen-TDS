SELECT * FROM (
    ...
    WHERE 1=1
        ...
        AND HDR.OPERATION IN (
            'Dry6_C2F6-25sccm_ValvePosition',
            'Dry6_C2F6-25sccm_C2F6Flow',
            'Dry6_C2F6-25sccm_RFPower',
            'Dry6_C2F6-25sccm_Pressure',
            'Dry6_C2F6-25sccm_InitialVpp',
            'Dry6_C2F6-25sccm_FinalVpp'
        )
    GROUP BY
        STARTTIME,
        OPERATORID,
