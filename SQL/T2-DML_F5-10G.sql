SELECT * FROM(
    ...
    WHERE 1=1
        ...
        AND THM2.MISCVALUE LIKE '%139S-T2.exe'
    GROUP BY
        STARTTIME,
        PARTNUMBER,
        SERIALNUMBER,
...
PIVOT(
    MAX(VALUE) FOR TESTSTEPS IN(
        ...
        'MO1-TEG_Step20' AS "MO1-TEG_Step20",
        'MO1-TEG_Step26' AS "MO1-TEG_Step26",
        'MO1-TEG_Step32' AS "MO1-TEG_Step32",
        ...
        'MO9-TMI_Step20' AS "MO9-TMI_Step20",
        'MO9-TMI_Step26' AS "MO9-TMI_Step26",
        'MO9-TMI_Step32' AS "MO9-TMI_Step32",
        'MO9-TMI_Step33' AS "MO9-TMI_Step33",
        'MO9-TMI_Step34' AS "MO9-TMI_Step34",
        'MO9-TMI_Step35' AS "MO9-TMI_Step35",
        'MO9-TMI_Step40' AS "MO9-TMI_Step40",
        'AsH3-A-20percent_Step26' AS "AsH3-1-20percent_Step26",
        'AsH3-A-20percent_Step32' AS "AsH3-1-20percent_Step32",
        ...
        'PH3-50percent_Step20' AS "PH3-50percent_Step20",
        'PH3-50percent_Step26' AS "PH3-50percent_Step26",
        'PH3-50percent_Step40' AS "PH3-50percent_Step40",
        ...
        'DMZn-B-0.1percent_Step20' AS "DMZn-B-0.1percent_Step20",
        'DMZn-B-0.1percent_Step26' AS "DMZn-B-0.1percent_Step26",
        'DMZn-B-0.1percent_Step32' AS "DMZn-B-0.1percent_Step32",
        ...
        'DMZn-B-0.1percent_Step40' AS "DMZn-B-0.1percent_Step40",
