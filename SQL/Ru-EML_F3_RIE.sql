...
FROM(
    ...
    WHERE 1=1
        ...
        AND HDR.OPERATION               = 'Ru-EML_F3RIE'
    GROUP BY
        HDR.TESTHEADERID,
        STARTTIME,
        PARTNUMBER,
...
PIVOT(
    MAX(VALUE) FOR TESTSTEPS IN(
        ...
        'MO7-TMI_Step9' AS "MO7-TMI_Step9",
        'MO7-TMI_Step10' AS "MO7-TMI_Step10",
        'MO6-Ru_Step9' AS "MO6-Ru_Step9",
        ...
        'CH3Cl-5percent_Step9' AS "CH3Cl-5percent_Step9",
