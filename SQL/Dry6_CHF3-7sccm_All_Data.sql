SELECT * FROM (
    ...
    WHERE 1=1
        ...
        AND HDR.OPERATION IN (
            'Dry6_CHF3-7sccm_ValvePosition',
            'Dry6_CHF3-7sccm_CHF3Flow',
            'Dry6_CHF3-7sccm_O2Flow',
            'Dry6_CHF3-7sccm_RFPower',
            'Dry6_CHF3-7sccm_Pressure',
            'Dry6_CHF3-7sccm_InitialVpp',
            'Dry6_CHF3-7sccm_FinalVpp'
        )
    GROUP BY
        STARTTIME,
        OPERATORID,
