SELECT * FROM (
    SELECT
      ...
      HDR.PARTNUMBER,
      HDR.SERIALNUMBER,
      OPS.OPERATIONSTEPNAME || '_' || PAR.PARAMETERNAME AS STEP_AND_PARAMETER,
      MSD.VALUE
    FROM
    ...
    WHERE 1=1
        ...
        AND HDR.OPERATION               = 'P-electrode_Deposition_Au-WetEtching'
)
PIVOT(
    MAX(VALUE) FOR STEP_AND_PARAMETER IN (
        'Width_Ave' AS "Width_Ave",
        'Width_MAX' AS "Width_MAX",
        'Width_MIN' AS "Width_MIN",
