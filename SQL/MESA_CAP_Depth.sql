SELECT * FROM (
    SELECT
      ...
      HDR.PARTNUMBER,
      HDR.SERIALNUMBER,
      MAX(CASE TEQ.DEVICENAME WHEN 'Dektak' THEN TEQ.DEVICENAME || TEQ.DEVICESERIALNUMBER END) AS "Dektak",
    ...
    WHERE 1=1
        ...
        AND HDR.OPERATION               = 'MESA_CAP_Depth'
    GROUP BY
        STARTTIME,
        OPERATORID,
        PARTNUMBER,
...
PIVOT(
    MAX(VALUE) FOR STEP_AND_PARAMETER IN (
        'Depth.Depth_Initial' AS "Depth.Depth_Initial",
        'Depth.Depth_Final' AS "Depth.Depth_Final",
