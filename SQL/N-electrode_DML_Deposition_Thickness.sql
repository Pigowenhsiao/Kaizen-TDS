SELECT * FROM (
    SELECT
      ...
      MAX(CASE THM.MISCDESC WHEN  'ProgramNo' THEN THM.MISCVALUE END) AS "ProgramNo",
    ...
    WHERE 1=1
        ...
        AND HDR.OPERATION               = 'N-electrode_DML_Deposition_Thickness'
        AND HDR.STARTTIME               > '2000-01-01'
    GROUP BY
        STARTTIME,
        OPERATORID,
        PARTNUMBER,
