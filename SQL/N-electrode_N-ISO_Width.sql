SELECT * FROM (
    ...
    WHERE 1=1
        ...
        AND HDR.OPERATION               = 'N-electrode_N-ISO_Width'
)
PIVOT(
    MAX(VALUE) FOR STEP_AND_PARAMETER IN (
        'Width.Center_L' AS "Width.Center_L",
        'Width.Center_R' AS "Width.Center_R",
        'Width.Outer_L' AS "Width.Outer_L",
        'Width.Outer_R' AS "Width.Outer_R",
