SELECT * FROM (
    ...
    where HDR.STARTTIME BETWEEN TRUNC(SYSDATE) - CHART_PERIOD_DAYS AND TRUNC(SYSDATE)
      AND HDR.OPERATION = 'EA_WG_Step_Height'
)
PIVOT(
    MAX(VALUE) FOR STEP_AND_PARAMETER IN (
		'EA_WG_Step_Height.Aa'         as "EA_WG_Step_Height.Aa",
		'EA_WG_Step_Height.Ah'         as "EA_WG_Step_Height.Ah",        
		'EA_WG_Step_Height.Dh'         as "EA_WG_Step_Height.Dh",        
		'EA_WG_Step_Height.V_Max'      as "EA_WG_Step_Height.V_Max",     
