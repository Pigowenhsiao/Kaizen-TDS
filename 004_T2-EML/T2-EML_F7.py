...
# ----- ログ書き込み先ファイルパス -----
Log_file = '../Log/' + Log_FolderName + '/004_T2-EML_F7.log'
...
def Open_Data_Sheet(Sheet, filepath, SheetName):
    ...
    Equipment1,Equipment2,Equipment3 = '1','1','7'  #F2->F7
...
if __name__ == "__main__":
    ...
    for filename in all_files:        
        ...
        if "A" in str(filename) and "$" not in str(filename) and os.path.isfile(filepath): #update F5 tool Lot Name
