...
Log_File = '../Log/' + Log_Folder_Name + '/025_PIX.log'
...
key_type = {
    ...
    'key_PIX_PIX4': float,
    'key_PIX_PIX5': float,
    'key_PIX_PIX_Ave': float,
    'key_SiO2_SiO2_1': float,
    'key_SiO2_SiO2_2': float,
    'key_SiO2_SiO2_3': float,
    'key_SiO2_SiO2_4': float,
    'key_SiO2_SiO2_5': float,
    'key_SiO2_SiO2_Ave': float,
...
def Main():
    ...
    Excel_File = shutil.copy(Excel_File_List[0][0], '../DataFile/025_PIX/')
    ...
    df = pd.read_excel(Excel_File, header=None, sheet_name=Data_Sheet_Name, usecols="B:X", skiprows=Start_Number)

    # ----- 使わない列を落とす -----
    df = df.drop(range(5, 11), axis=1)
    ...
    while Row_Number < row_end:
        ...
        data_dict = {
            ...
            'key_PIX_PIX1' : df.iloc[Row_Number, Col_PIX_PIX1],
            'key_PIX_PIX2' : df.iloc[Row_Number, Col_PIX_PIX2],
            'key_PIX_PIX3' : df.iloc[Row_Number, Col_PIX_PIX3],
            'key_PIX_PIX4' : df.iloc[Row_Number, Col_PIX_PIX4],
            'key_PIX_PIX5' : df.iloc[Row_Number, Col_PIX_PIX5],
            'key_PIX_PIX_Ave' : df.iloc[Row_Number, Col_PIX_PIX_Ave],
            'key_SiO2_SiO2_1' : df.iloc[Row_Number, Col_SiO2_SiO2_1],
            'key_SiO2_SiO2_2' : df.iloc[Row_Number, Col_SiO2_SiO2_2],
            'key_SiO2_SiO2_3' : df.iloc[Row_Number, Col_SiO2_SiO2_3],
            'key_SiO2_SiO2_4' : df.iloc[Row_Number, Col_SiO2_SiO2_4],
            'key_SiO2_SiO2_5' : df.iloc[Row_Number, Col_SiO2_SiO2_5],
            'key_SiO2_SiO2_Ave' : df.iloc[Row_Number, Col_SiO2_SiO2_Ave],
        ...
        f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
                ...
                '\n'
                '               <TestStep Name="PIX" startDateTime=' + '"' + data_dict["key_Start_Date_Time"].replace(".", ":") + '"' + ' Status="Passed">' + '\n' +
                '                   <Data DataType="Numeric" Name="PIX_1" Units="nm" Value=' + '"' + str(data_dict["key_PIX_PIX1"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="PIX_2" Units="nm" Value=' + '"' + str(data_dict["key_PIX_PIX2"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="PIX_3" Units="nm" Value=' + '"' + str(data_dict["key_PIX_PIX3"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="PIX_4" Units="nm" Value=' + '"' + str(data_dict["key_PIX_PIX4"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="PIX_5" Units="nm" Value=' + '"' + str(data_dict["key_PIX_PIX5"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="PIX_Ave" Units="nm" Value=' + '"' + str(data_dict["key_PIX_PIX_Ave"]) + '"/>' + '\n' +
                '               </TestStep>' + '\n' +
                '               <TestStep Name="SiO2" startDateTime=' + '"' + data_dict["key_Start_Date_Time"].replace(".", ":") + '"' + ' Status="Passed">' + '\n' +
                '                   <Data DataType="Numeric" Name="SiO2_1" Units="nm" Value=' + '"' + str(data_dict["key_SiO2_SiO2_1"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="SiO2_2" Units="nm" Value=' + '"' + str(data_dict["key_SiO2_SiO2_2"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="SiO2_3" Units="nm" Value=' + '"' + str(data_dict["key_SiO2_SiO2_3"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="SiO2_4" Units="nm" Value=' + '"' + str(data_dict["key_SiO2_SiO2_4"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="SiO2_5" Units="nm" Value=' + '"' + str(data_dict["key_SiO2_SiO2_5"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="SiO2_Ave" Units="nm" Value=' + '"' + str(data_dict["key_SiO2_SiO2_Ave"]) + '"/>' + '\n' +
                '               </TestStep>' + '\n' +
                ...
                '\n'
                '               <TestEquipment>' + '\n' +
                '                   <Item DeviceName="Nanospec" DeviceSerialNumber="' + str(data_dict['key_Equipment']) + '"/>' + '\n' +
                '               </TestEquipment>' + '\n' +
                '\n'
                '               <ErrorData/>' + '\n' +
                '               <FailureData/>' + '\n' +
    ...
    shutil.copy("PIX_StartRow.txt", 'T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/025_PIX/13_ProgramUsedFile/')
