...
def Main():
    ...
    df = pd.read_excel(Excel_File, header=None, sheet_name=Data_Sheet_Name, usecols="B:AI", skiprows=Start_Number)
    ...
    shutil.copy("GRATING_StartRow.txt", 'C:/Users/fus86274/Documents/fuse/0010_Kaizen-TDS_開発/test/01_開発/009_GRATING/')
