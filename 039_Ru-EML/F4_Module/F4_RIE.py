...
key_type = {
    ...
    "key_MO1-Ru_Step9" : float,
    "key_MO1-Ru_Step10" : float,
    "key_MO3-TMI_Step9" : float,
...
def Open_Data_Sheet(file_path, SheetName, Multi_CH_List):
    ...
    data_dict = {
        ...
        "key_Particles_Particles" : sheet['AD52'].value,
        "key_BallastN2_BallastN2" : sheet['AE40'].value,
        "key_MO-Temperature_MO1-Ru" : sheet["K40"].value,
        "key_MO-Temperature_MO2-Fe" : sheet["L40"].value,
        "key_MO-Temperature_MO3-TMI" : sheet["M40"].value,
        "key_MO-Temperature_MO4-TMA-A" : sheet["N40"].value,
        "key_MO-Temperature_MO5-TEG-A" : sheet["P40"].value,
        "key_Dulation_Step9" : sheet['I22'].value,
        "key_Dulation_Step10" : sheet['I23'].value,
        "key_MO1-Ru_Step9" : sheet['K22'].value,
        "key_MO1-Ru_Step10" : sheet['K23'].value,
        "key_MO3-TMI_Step9" : sheet['M22'].value,
        "key_MO3-TMI_Step10" : sheet['M23'].value,
        "key_CH3Cl_Step9" : sheet['T22'].value,
        "key_CH3Cl_Step10" : sheet['T23'].value,
        "key_PH3_Step9" : sheet['V22'].value,
        "key_PH3_Step10" : sheet['V23'].value,
        "key_Temperature_Step9" : sheet["Z22"].value,
        "key_Temperature_Step10" : sheet["Z23"].value,
        "key_TMInPiezoconConc_TMInPiezoconConc_Check" : sheet["AD29"].value,
        "key_TMInPiezoconConc_TMInPiezoconConc_EPI" : sheet["AD30"].value,
        "key_TMInPiezoconConc_TMInPiezoconConc_CheckFlow" : sheet["AD32"].value,
        "key_CH3Cl_Conc_CH3Cl_ConcBonbe" : sheet['AD34'].value,
...
def Output_XML(xml_file, data_dict):
    ...
    f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step9" Units="sccm" Value=' + '"' + str(data_dict["key_MO1-Ru_Step9"]) + '"/>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step9" Units="sccm" Value=' + '"' + str(data_dict["key_MO3-TMI_Step9"]) + '"/>' + '\n' +
