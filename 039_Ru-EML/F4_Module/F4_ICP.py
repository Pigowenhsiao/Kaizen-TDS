...
# Output_filepath = '../XML/039_Ru-EML/F4/'
...
teststep_dict = {
    ...
    'TestStep12': 'CH3Cl_Conc',
    'TestStep13': 'Thickness',
    'TestStep14' : 'SORTED_DATA'
}
...
key_type = {
    ...
    "key_MO-Temperature_MO1-Ru" : float,
    "key_MO-Temperature_MO2-Fe" : float,
    "key_MO-Temperature_MO3-TMI" : float,
    "key_MO-Temperature_MO4-TMA-A" : float,
    "key_MO-Temperature_MO5-TEG-A" : float,
    ...
    "key_MO1-Ru_Step10" : float,
    "key_MO1-Ru_Step11" : float,
    "key_MO3-TMI_Step10" : float,
    "key_MO3-TMI_Step11" : float,
    "key_CH3Cl_Step7" : float,
    "key_CH3Cl_Step8" : float,
    "key_CH3Cl_Step9" : float,
    "key_CH3Cl_Step10" : float,
    "key_CH3Cl_Step11" : float,
    "key_PH3_Step7" : float,
    "key_PH3_Step8" : float,
    "key_PH3_Step9" : float,
    "key_PH3_Step10" : float,
    "key_PH3_Step11" : float,
...
def Get_Cells_Info(file_path, SheetName):
    ...
    if Sheet['I8'].value is None or \
        Sheet['S7'].value is None or \
        Sheet['X8'].value is None or \
        Sheet['AE42'].value is None:
        is_cells_empty = True
...
def Open_Data_Sheet(file_path, SheetName, Multi_CH_List):
    ...
    # ----- データの取り出し -----
    data_dict = {
        "key_start_date_time" : str(sheet['S7'].value).replace(" ", "T"),
        "key_serial_number" : serial_number,
        "key_part_number" : part_number,
        "key_LotNumber_9": Nine_Serial_Number,
        "key_operator" : sheet['X8'].value,
        ...
        "key_Particles_Particles_All_Address" : sheet['AD50'].value,
        "key_Particles_Particles_Center" : sheet['AD51'].value,
        "key_Particles_Particles_NG_Count" : sheet['AD52'].value,
        "key_Particles_Particles_NG_Address" : sheet['AD53'].value,
        "key_Particles_Particles" : sheet['AD54'].value,
        "key_BallastN2_BallastN2" : sheet['AE42'].value,
        "key_MO-Temperature_MO1-Ru" : sheet["K42"].value,
        "key_MO-Temperature_MO2-Fe" : sheet["L42"].value,
        "key_MO-Temperature_MO3-TMI" : sheet["M42"].value,
        "key_MO-Temperature_MO4-TMA-A" : sheet["N42"].value,
        "key_MO-Temperature_MO5-TEG-A" : sheet["P42"].value,
        "key_Dulation_Step7" : sheet['I21'].value,
        "key_Dulation_Step8" : sheet['I22'].value,
        "key_Dulation_Step9" : sheet['I23'].value,
        "key_Dulation_Step10" : sheet['I24'].value,
        "key_Dulation_Step11" : sheet['I25'].value,
        "key_MO1-Ru_Step10" : sheet['K24'].value,
        "key_MO1-Ru_Step11" : sheet['K25'].value,
        "key_MO3-TMI_Step10" : sheet['M24'].value,
        "key_MO3-TMI_Step11" : sheet['M25'].value,
        "key_CH3Cl_Step7" : sheet['T21'].value,
        "key_CH3Cl_Step8" : sheet['T22'].value,
        "key_CH3Cl_Step9" : sheet['T23'].value,
        "key_CH3Cl_Step10" : sheet['T24'].value,
        "key_CH3Cl_Step11" : sheet['T25'].value,
        "key_PH3_Step7" : sheet['V21'].value,
        "key_PH3_Step8" : sheet['V22'].value,
        "key_PH3_Step9" : sheet['V23'].value,
        "key_PH3_Step10" : sheet['V24'].value,
        "key_PH3_Step11" : sheet['V25'].value,
        "key_Temperature_Step7" : sheet["Z21"].value,
        "key_Temperature_Step8" : sheet["Z22"].value,
        "key_Temperature_Step9" : sheet["Z23"].value,
        "key_Temperature_Step10" : sheet["Z24"].value,
        "key_Temperature_Step11" : sheet["Z25"].value,
        "key_TMInPiezoconConc_TMInPiezoconConc_Check" : sheet["AD31"].value,
        "key_TMInPiezoconConc_TMInPiezoconConc_EPI" : sheet["AD32"].value,
        "key_TMInPiezoconConc_TMInPiezoconConc_CheckFlow" : sheet["AD34"].value,
        "key_CH3Cl_Conc_CH3Cl_ConcBonbe" : sheet['AD36'].value,
        ...
        "key_Equipment_MOCVD" : "4"
    }

    # ----- 空欄箇所はNoneとして取得される。Noneは文字列に変換できないため、空欄("") -----
...
def Output_XML(xml_file, data_dict):
    ...
    f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="MO1-Ru" Units="degree" Value=' + '"' + str(data_dict["key_MO-Temperature_MO1-Ru"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="MO2-Fe" Units="degree" Value=' + '"' + str(data_dict["key_MO-Temperature_MO2-Fe"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="MO3-TMI" Units="degree" Value=' + '"' + str(data_dict["key_MO-Temperature_MO3-TMI"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="MO4-TMA-A" Units="degree" Value=' + '"' + str(data_dict["key_MO-Temperature_MO4-TMA-A"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="MO5-TEG-A" Units="degree" Value=' + '"' + str(data_dict["key_MO-Temperature_MO5-TEG-A"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step8" Units="min" Value=' + '"' + str(data_dict["key_Dulation_Step8"]) + '"/>' + '\n' +
            ...
            '                   <Data DataType="Numeric" Name="Step10" Units="sccm" Value=' + '"' + str(data_dict["key_MO1-Ru_Step10"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step11" Units="sccm" Value=' + '"' + str(data_dict["key_MO1-Ru_Step11"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            '               <TestStep Name=' + '"' + teststep_dict["TestStep7"] + '"' + ' startDateTime=' + '"' + data_dict["key_start_date_time"] + '"' + ' Status="Passed">' + '\n' +
            '                   <Data DataType="Numeric" Name="Step10" Units="sccm" Value=' + '"' + str(data_dict["key_MO3-TMI_Step10"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step11" Units="sccm" Value=' + '"' + str(data_dict["key_MO3-TMI_Step11"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            '               <TestStep Name=' + '"' + teststep_dict["TestStep8"] + '"' + ' startDateTime=' + '"' + data_dict["key_start_date_time"] + '"' + ' Status="Passed">' + '\n' +
            '                   <Data DataType="Numeric" Name="Step7" Units="sccm" Value=' + '"' + str(data_dict["key_CH3Cl_Step7"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step8" Units="sccm" Value=' + '"' + str(data_dict["key_CH3Cl_Step8"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step9" Units="sccm" Value=' + '"' + str(data_dict["key_CH3Cl_Step9"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step10" Units="sccm" Value=' + '"' + str(data_dict["key_CH3Cl_Step10"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step11" Units="sccm" Value=' + '"' + str(data_dict["key_CH3Cl_Step11"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
            '               <TestStep Name=' + '"' + teststep_dict["TestStep9"] + '"' + ' startDateTime=' + '"' + data_dict["key_start_date_time"] + '"' + ' Status="Passed">' + '\n' +
            '                   <Data DataType="Numeric" Name="Step7" Units="sccm" Value=' + '"' + str(data_dict["key_PH3_Step7"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step8" Units="sccm" Value=' + '"' + str(data_dict["key_PH3_Step8"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step9" Units="sccm" Value=' + '"' + str(data_dict["key_PH3_Step9"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step10" Units="sccm" Value=' + '"' + str(data_dict["key_PH3_Step10"]) + '"/>' + '\n' +
            '                   <Data DataType="Numeric" Name="Step11" Units="sccm" Value=' + '"' + str(data_dict["key_PH3_Step11"]) + '"/>' + '\n' +
            '               </TestStep>' + '\n' +
