...
Operation = 'N-electrode_EML_LiftOffPhotoPattern_Eaves'
...
Log_File = '../Log/' + Log_Folder_Name + '/035_N-electrode_EML_LiftOffPhotoPattern_Eaves.log'
Log.Log_Info(Log_File, 'Program Start')


########## 使用するシート名と開始行数を取り出すファイルを定義 ##########
Sheet_Text_Array = [
    ["HTL13B2・B4・B5・B6", "HTL13B2_etc_StartRow_PPE.txt"],
    ["HTL13D1", "HTL13D1_StartRow_PPE.txt"]
]
