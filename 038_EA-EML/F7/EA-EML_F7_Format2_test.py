...
########## XML出力先ファイルパス ##########
Output_filepath = '//sagqnap01.li.lumentuminc.net/data/SAG/TDS/Data/Files to Insert/XML/'
#Output_filepath = '../XML/'
...
if __name__ == '__main__':
    ...
    Path = [ "//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#4/_PLマッパー判定/HL13B5/F7EA/ロット採番済み/"] #Add->Correct 2025/2/6 M.Yoshida
    for p in Path:
        ALL_FILE_FETCH(p)
