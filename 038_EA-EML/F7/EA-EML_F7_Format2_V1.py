...
if __name__ == '__main__':
    ...
    Path = ["//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#4/_PLマッパー判定/HL13B5/F7EA/ロット採番済み/","//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHTL13B4/F7 EA/", "//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHTL13B5/F7 EA/", "//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#2/★PLﾏｯﾊﾟｰ判定/HL13B4/F7EA/", \
  		"//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#2/★PLﾏｯﾊﾟｰ判定/HL13B5/F7EA/", "//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#3/★PLﾏｯﾊﾟｰ判定/HL13B5/F7EA/ﾛｯﾄ採番済"] #Add->Correct 2025/2/6 M.Yoshida
    Path = ["//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#4/_PLマッパー判定/HL13B5/F7EA/ロット採番済み/","//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHTL13B4/F7 EA/"]
    for p in Path:
            ALL_FILE_FETCH(p)
    ...
    for FilePath in ALL_FILES:
        ...
        if (datetime.now() - file_mod_time).days > 15:
            Log.Log_Info(Log_file, FilePath,f"File skipped due to modification time > 15 days:")
            continue
        
        print(FilePath,file_mod_time)
                # ----- ファイルパスからファイル名を取り出し定義 -----
        if not os.path.exists(FilePath):
            Log.Log_Error(Log_file, f"File not found: {FilePath}")
            continue
