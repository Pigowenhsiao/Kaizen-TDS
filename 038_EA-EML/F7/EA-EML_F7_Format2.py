...
if __name__ == '__main__':
    ...
    input_folder = ["//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#4/_PLマッパー判定/HL13B5/F7EA/ロット採番済み/",
                    "//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHTL13B4/F7 EA/",
                    "//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHTL13B5/F7 EA/",
                    "//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#2/★PLﾏｯﾊﾟｰ判定/HL13B4/F7EA/",
                    "//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#2/★PLﾏｯﾊﾟｰ判定/HL13B5/F7EA/",
                    "//sagqnap01.li.lumentuminc.net/K11Data/PL-MAP#3/★PLﾏｯﾊﾟｰ判定/HL13B5/F7EA/ﾛｯﾄ採番済"] #Add->Correct 2025/2/6 M.Yoshida
    #input_folder=['../../InputFolder/']

    for p in input_folder:
        ALL_FILE_FETCH(p)
    ...
    for FilePath in ALL_FILES:
        ...
        #print(FilePath,file_mod_time,datetime.now() - file_mod_time ) #comment out 2025/3/11 yoshida
        if (datetime.now() - file_mod_time).days > 30:
            Log.Log_Info(Log_file, f"File is older than 30 days, skipping.")
            continue
        File = os.path.basename(FilePath)
        #print(File, "read ready") #comment out 2025/3/11 yoshida
        # ----- 処理を行ったファイルであれば、処理を行わず次のファイルへ -----
        if File in EndFiles or '~$' in File:
           # print(EndFiles,"temp file or uploaded file skip") #comment out 2025/3/11 yoshida
            continue
