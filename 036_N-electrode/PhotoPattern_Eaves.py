...
Operation = 'N-electrode_DML_LiftOffPhotoPattern_Eaves'
...
Log_File = '../Log/' + Log_Folder_Name + '/036_N-electrode_DML_LiftOffPhotoPattern_Eaves.log'
Log.Log_Info(Log_File, 'Program Start')


########## 使用するシート名と開始行数を取り出すファイルを定義 ##########
Sheet_Text_Array = [
    ["HL13BFCP-BT", "HL13BFCP_StartRow_PPE.txt"],
    ["HTL139S・HL1361_2_3", "HTL139S_etc_StartRow_PPE.txt"],
    ["HL13BE・BS･CE・CG", "HL13BE_etc_StartRow_PPE.txt"]
]
...
Col_Operator = 1
Col_PhotoPattern_Eaves_Ave = 5
Col_PhotoPattern_Eaves_Max = 6
Col_PhotoPattern_Eaves_Min = 7
Col_Serial_Number = 8
...
key_type = {
    ...
    "key_Operator": str,
    "key_PhotoPattern_Eaves_Ave": float,
    "key_PhotoPattern_Eaves_Max": float,
    "key_PhotoPattern_Eaves_Min": float,
...
def Main(Data_Sheet_Name, TextFile):
    ...
    df = pd.read_excel(Excel_File, header=None, sheet_name=Data_Sheet_Name, usecols="L:S", skiprows=Start_Number)
    ...
    while Row_Number < row_end:
        ...
        data_dict = {
            ...
            "key_PhotoPattern_Eaves_Ave": df.iloc[Row_Number, Col_PhotoPattern_Eaves_Ave],
            "key_PhotoPattern_Eaves_Max": df.iloc[Row_Number, Col_PhotoPattern_Eaves_Max],
            "key_PhotoPattern_Eaves_Min": df.iloc[Row_Number, Col_PhotoPattern_Eaves_Min]
        }
        ...
        f.write('<?xml version="1.0" encoding="utf-8"?>' + '\n' +
                ...
                '                   <Data DataType="Numeric" Name="Ave" Units="um" Value=' + '"' + str(data_dict["key_PhotoPattern_Eaves_Ave"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="Max" Units="um" Value=' + '"' + str(data_dict["key_PhotoPattern_Eaves_Max"]) + '"/>' + '\n' +
                '                   <Data DataType="Numeric" Name="Min" Units="um" Value=' + '"' + str(data_dict["key_PhotoPattern_Eaves_Min"]) + '"/>' + '\n' +
                '               </TestStep>' + '\n' +
                '\n'
                ...
                '\n'
                '               <TestEquipment>' + '\n' +
                '                   <Item DeviceName="-" DeviceSerialNumber="-"/>' + '\n' +
                '               </TestEquipment>' + '\n' +
                '\n'
                '               <ErrorData/>' + '\n' +
                '               <FailureData/>' + '\n' +
