...
Operation = 'N-electrode_EML_Deposition_Thickness'
...
def Main(FilePath, FileName, TextFile, Data_Sheet_Name, Equipment):
    ...
    Excel_File = shutil.copy(Excel_File_List[0][0], '../DataFile/033_N-electrode/')
    ...
    while Row_Number < row_end:
        ...
        for Serial_Number in Serial_Number_List:
            ...
            if Part_Class_Check(Part_Number) != "25G-EA" or (data_dict["key_Program_No"] != "29.0" and data_dict["key_Program_No"] != "29"):
    ...
    #shutil.copy(TextFile, 'T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/033_N-electrode/13_ProgramUsedFile/')


if __name__ == '__main__':
    
    Main("Z:/電極/着工記録/EB蒸着#4号機/", "*EB蒸着#4号機作業着工記録*.xlsx", "EB4_StartRow.txt", "EB蒸着#4着工記録", '#4') #2025/01/10 追加
    Main("Z:/電極/着工記録/EB蒸着#1号機/", "*EB蒸着作業着工記録*.xls*", "EB1_StartRow.txt", "EB蒸着着工記録", '#1')
