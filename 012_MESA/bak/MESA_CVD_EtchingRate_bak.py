...
Operation = 'MESA_CVD_EtchingRate'
TestStation = 'MESA'
...
Log_File = '../Log/' + Log_Folder_Name + '/012_MESA.log'
...
def Main(FilePath, FileName, TextFile, Equipment):
    ...
    Excel_File = shutil.copy(Excel_file_list[0][0], '../DataFile/012_MESA/')
    ...
    df = pd.read_excel(Excel_File, header=None, sheet_name=Data_Sheet_Name, usecols="B:AL", skiprows=Start_Number)

    # ----- 使わない列を落とす -----
    df = df.drop(range(26, 28), axis=1)
    ...
    shutil.copy(TextFile, 'T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/012_MESA/13_ProgramUsedFile/')


if __name__ == '__main__':
    
    Main("Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ8号機/3ｲﾝﾁ/EA系/", "*3ｲﾝﾁ_HTL13★xx_ ﾒｻSiO2膜ﾄﾞﾗｲｴｯﾁ(ドライ8号機)ﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsm", 'MESA_Dry8_StartRow.txt', '#8')

    Main("Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ3号機/3ｲﾝﾁ/EA系/", "*3ｲﾝﾁ_HTL13★xx_*ﾒｻSiO2膜ﾄﾞﾗｲｴｯﾁﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsm", 'MESA_Dry3_StartRow.txt', '#3')
    Main("Z:/ホト・エッチング/製品/ﾄﾞﾗｲｴｯﾁ6号機/3ｲﾝﾁ/EA系/", "*3ｲﾝﾁ_HTL13★xx_*ﾒｻSiO2膜ﾄﾞﾗｲｴｯﾁ(ドライ6号機)ﾌﾟﾛｸﾞﾗﾑｼｰﾄ*.xlsm", 'MESA_Dry6_StartRow.txt', '#6')
