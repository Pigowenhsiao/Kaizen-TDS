...
def Open_Data_Sheet(file_path):
    ...
    serial_number = sheet.cell(3, 8).value
    ...
    print(part_number, Nine_Serial_Number, serial_number)
    ...
    data_dict = {
        ...
        "key_Mapper_Average_Mapper_PL_Lambda2": (sheet.cell(13, 5).value+sheet.cell(14, 5).value+sheet.cell(15, 5).value+sheet.cell(16, 5).value)/4, #2025/01/15 update
