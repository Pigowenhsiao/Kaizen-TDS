...
# Output_filepath = '../../XML/040_LD-EML/F6_Format1/'
...
def Data_Extract(filepath, SheetList):
    ...
    for Sheet_Name in Sheets:
        ...
        if Initial not in SerialNumber_list or ('13B2-LD' not in str(Sheet['W3'].value) and '13B4-LD' not in str(Sheet['W3'].value) and '13B5-LD' not in str(Sheet['W3'].value)):
