...
# ----- ログ書き込み先ファイルパス -----
Log_File = '../../Log/' + Log_FolderName + '/040_LD-EML_F1_Format2.log'
...
#Output_filepath = './'
# Output_filepath = '../../XML/040_LD-EML/F1_Format2/'
...
def Open_Data_Sheet(file_path):
    ...
    serial_number = sheet.cell(3, 7).value
...
if __name__ == '__main__':
    ...
    #Path = ["Z:/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHTL13B4/F1 LD(仮)/", "Z:/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHTL13B5/F1 LD/", "Z:/PL-MAP#2/★PLﾏｯﾊﾟｰ判定/HL13B4/F1 LD(仮)/", "Z:/PL-MAP#2/★PLﾏｯﾊﾟｰ判定/HL13B5/F1 LD/"]
    Path = [
        "Z:/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHTL13B4/F1 LD/",
        "Z:/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHTL13B5/F1 LD/",
        "Z:/PL-MAP#2/★PLﾏｯﾊﾟｰ判定/HL13B5/F1 LD/",
        "Z:/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHL13B8/F1LD/",
        "Z:/PL-MAP#2/★PLﾏｯﾊﾟｰ判定/HL13B8/F1LD/",
        "Z:/PL-MAP#3/★PLﾏｯﾊﾟｰ判定/HL13B8/F1LD/",
        "Z:/PL-MAP/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHL13E1/F1LD",
        "Z:/PL-MAP#2/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHL13E1/F1LD",
        "Z:/PL-MAP#3/★PLﾏｯﾊﾟｰ判定/3ｲﾝﾁHL13E1/F1LD"
    ]
    for p in Path:
        ALL_FILE_FETCH(p)
    ...
    #shutil.copy('EndsFile_F1_Format2.txt', 'T:/04_プロセス関係/10_共通/91_KAIZEN-TDS/01_開発/040_LD-EML/F1/13_ProgramUsedFile/')
